      ...
      <div className="w-full flex-1 pr-2 overflow-y-auto scrollbar-hide flex items-center">
        <div className="space-y-6 text-center w-full">
          <p className="text-base leading-relaxed text-foreground">
            I'm Omollo Victor — <span className="text-primary font-bold">Full Stack Engineer</span> & <span className="text-primary font-bold">Founder of CareerGuide AI</span>. I build secure, scalable systems that solve real-world problems and drive real impact.
          </p>
