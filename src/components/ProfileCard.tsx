...
const ProfileCard = ({ onAIClick }: ProfileCardProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-6 h-full px-2 sm:px-0" role="region" aria-label="Profile Card">
          ...
          <div className="transition-transform duration-200 hover:scale-105 hover:shadow-2xl rounded-full border-4 border-primary/30 shadow-xl overflow-hidden w-32 h-32 sm:w-40 sm:h-40">
            <picture>
              ...
              <img
                ...
                alt="Omollo Victor Otieno - Full-Stack Software Engineer and Founder of CareerGuide AI"
      ...
      <div className="flex flex-wrap justify-center gap-2 sm:gap-4 max-w-md" role="list" aria-label="Professional details">
        <div className="flex items-center space-x-2 p-2 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-all duration-200 text-xs sm:text-sm" role="listitem">
          <Briefcase className="w-4 h-4 text-primary" aria-hidden="true" />
          <div>
            <span className="font-medium">Automation Engineer at </span>
            <a href="https://customcx.com" target="_blank" rel="noopener noreferrer" className="font-bold text-primary" aria-label="CustomCX - AI Automation Agency">CustomCX</a>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 p-2 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-all duration-200 text-xs sm:text-sm" role="listitem">
          ...
          <div>
            ...
            <a href="http://careerguideai.co.ke/" target="_blank" rel="noopener noreferrer" className="font-bold text-primary" aria-label="CareerGuide AI - AI Career Counseling Platform">CareerGuide AI</a>
          </div>
        </div>
        ...
        <a href="https://github.com/SK3CHI3" target="_blank" rel="noopener noreferrer" aria-label="Visit Omollo Victor's GitHub profile" className="flex items-center space-x-2 p-2 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-all duration-200 text-xs sm:text-sm" role="listitem">
      ...
      <div className="flex flex-col sm:flex-row w-full sm:w-auto space-y-3 sm:space-y-0 sm:space-x-4 mt-2" role="group" aria-label="Contact actions">
        <Button 
          onClick={handleHireMe}
          aria-label="Hire Omollo Victor - Send a hiring inquiry email"
        ...
        <Button 
          ...
          aria-label="View Omollo Victor's resume on Google Drive"
          variant="outline" 
