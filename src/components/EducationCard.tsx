...
const educationList = [
  ...
  },
  {
    ...
    details: [
      "Hands-on training in web app hacking: HTTP requests, auth bypass, XSS, etc.",
      "Focused on securing APIs & backends through real-world labs",
      "Built offensive & defensive skills for modern web app security",
    ],
  },
];
